...
const MONSTERS_DATA = {
    ...
    "pretre_corrompu": {
        name: "Prêtre Corrompu", maxHp: 80, maxMp: 80, str: 4, def: 8, int: 15, magDef: 20, xpReward: 100,
    ...
    "orc": {
        name: "Orc", maxHp: 120, maxMp: 20, str: 18, def: 15, int: 2, magDef: 5, xpReward: 110,
    ...
    "dragonnet": {
        name: "Dragonnet (Boss)", maxHp: 400, maxMp: 100, str: 30, def: 25, int: 30, magDef: 20, xpReward: 500,
